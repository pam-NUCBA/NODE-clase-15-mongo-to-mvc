...
const getOneUser = async (req, res) => {
  try {
    ...
    res.json({ message: `error retrieving user with id ${req.params.id}` });
  }
};
...
const updateUser = async (req, res) => {
  try {
    ...
    res.json({ message: `error updating user with id ${req.params.id}` });
  }
};
...
const deleteUser = async (req, res) => {
  try {
    ...
    res.json({ message: "error removing users" });
  }
};
